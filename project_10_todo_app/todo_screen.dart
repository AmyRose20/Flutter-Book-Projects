  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                /* In order to create some space between the form widgets,
                each 'TextField' will be included in a 'Padding' widget. */
                Padding(
                ...
                Padding(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text('Save'),
                      onPressed: () {
                        /* 'pushAndRemoveUntil' will delete the navigation
                        stack, which means it doesn't have to show the
                        back button from the home screen. */
